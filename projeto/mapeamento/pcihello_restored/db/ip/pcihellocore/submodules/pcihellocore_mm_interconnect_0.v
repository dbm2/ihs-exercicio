...
module pcihellocore_mm_interconnect_0 (
	...
	wire  [115:0] hexport2_s1_agent_rf_source_data;                                       // hexport2_s1_agent:rf_source_data -> hexport2_s1_agent_rsp_fifo:in_data
	...
	wire  [115:0] hexport2_s1_agent_rsp_fifo_out_data;                                    // hexport2_s1_agent_rsp_fifo:out_data -> hexport2_s1_agent:rf_sink_data
	...
	wire          hexport2_s1_agent_rp_valid;                                             // hexport2_s1_agent:rp_valid -> router_004:sink_valid
	wire  [114:0] hexport2_s1_agent_rp_data;                                              // hexport2_s1_agent:rp_data -> router_004:sink_data
	wire          hexport2_s1_agent_rp_ready;                                             // router_004:sink_ready -> hexport2_s1_agent:rp_ready
	wire          hexport2_s1_agent_rp_startofpacket;                                     // hexport2_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          hexport2_s1_agent_rp_endofpacket;                                       // hexport2_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	wire          button_s1_agent_rp_valid;                                               // button_s1_agent:rp_valid -> router_005:sink_valid
	wire  [114:0] button_s1_agent_rp_data;                                                // button_s1_agent:rp_data -> router_005:sink_data
	...
	wire          fan_s1_agent_rp_valid;                                                  // fan_s1_agent:rp_valid -> router_008:sink_valid
	wire  [114:0] fan_s1_agent_rp_data;                                                   // fan_s1_agent:rp_data -> router_008:sink_data
	wire          fan_s1_agent_rp_ready;                                                  // router_008:sink_ready -> fan_s1_agent:rp_ready
	wire          fan_s1_agent_rp_startofpacket;                                          // fan_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          fan_s1_agent_rp_endofpacket;                                            // fan_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [114:0] hexport2_s1_burst_adapter_source0_data;                                 // hexport2_s1_burst_adapter:source0_data -> hexport2_s1_agent:cp_data
	wire          hexport2_s1_burst_adapter_source0_ready;                                // hexport2_s1_agent:cp_ready -> hexport2_s1_burst_adapter:source0_ready
	wire    [8:0] hexport2_s1_burst_adapter_source0_channel;                              // hexport2_s1_burst_adapter:source0_channel -> hexport2_s1_agent:cp_channel
	...
	wire    [8:0] fan_s1_burst_adapter_source0_channel;                                   // fan_s1_burst_adapter:source0_channel -> fan_s1_agent:cp_channel
	...
	wire          router_004_src_valid;                                                   // router_004:src_valid -> hexport2_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_004_src_data;                                                    // router_004:src_data -> hexport2_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                   // hexport2_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [8:0] router_004_src_channel;                                                 // router_004:src_channel -> hexport2_s1_rsp_width_adapter:in_channel
	wire          router_004_src_startofpacket;                                           // router_004:src_startofpacket -> hexport2_s1_rsp_width_adapter:in_startofpacket
	wire          router_004_src_endofpacket;                                             // router_004:src_endofpacket -> hexport2_s1_rsp_width_adapter:in_endofpacket
	wire          hexport2_s1_rsp_width_adapter_src_valid;                                // hexport2_s1_rsp_width_adapter:out_valid -> rsp_demux_003:sink_valid
	wire  [150:0] hexport2_s1_rsp_width_adapter_src_data;                                 // hexport2_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	wire          hexport2_s1_rsp_width_adapter_src_ready;                                // rsp_demux_003:sink_ready -> hexport2_s1_rsp_width_adapter:out_ready
	wire    [8:0] hexport2_s1_rsp_width_adapter_src_channel;                              // hexport2_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	wire          hexport2_s1_rsp_width_adapter_src_startofpacket;                        // hexport2_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_003:sink_startofpacket
	wire          hexport2_s1_rsp_width_adapter_src_endofpacket;                          // hexport2_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_003:sink_endofpacket
	wire          router_005_src_valid;                                                   // router_005:src_valid -> button_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_005_src_data;                                                    // router_005:src_data -> button_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                   // button_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [8:0] router_005_src_channel;                                                 // router_005:src_channel -> button_s1_rsp_width_adapter:in_channel
	...
	wire          button_s1_rsp_width_adapter_src_valid;                                  // button_s1_rsp_width_adapter:out_valid -> rsp_demux_004:sink_valid
	wire  [150:0] button_s1_rsp_width_adapter_src_data;                                   // button_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          button_s1_rsp_width_adapter_src_ready;                                  // rsp_demux_004:sink_ready -> button_s1_rsp_width_adapter:out_ready
	wire    [8:0] button_s1_rsp_width_adapter_src_channel;                                // button_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	wire          button_s1_rsp_width_adapter_src_startofpacket;                          // button_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_004:sink_startofpacket
	wire          button_s1_rsp_width_adapter_src_endofpacket;                            // button_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_004:sink_endofpacket
	...
	wire          router_008_src_valid;                                                   // router_008:src_valid -> fan_s1_rsp_width_adapter:in_valid
	wire  [114:0] router_008_src_data;                                                    // router_008:src_data -> fan_s1_rsp_width_adapter:in_data
	wire          router_008_src_ready;                                                   // fan_s1_rsp_width_adapter:in_ready -> router_008:src_ready
	wire    [8:0] router_008_src_channel;                                                 // router_008:src_channel -> fan_s1_rsp_width_adapter:in_channel
	wire          router_008_src_startofpacket;                                           // router_008:src_startofpacket -> fan_s1_rsp_width_adapter:in_startofpacket
	wire          router_008_src_endofpacket;                                             // router_008:src_endofpacket -> fan_s1_rsp_width_adapter:in_endofpacket
	wire          fan_s1_rsp_width_adapter_src_valid;                                     // fan_s1_rsp_width_adapter:out_valid -> rsp_demux_007:sink_valid
	wire  [150:0] fan_s1_rsp_width_adapter_src_data;                                      // fan_s1_rsp_width_adapter:out_data -> rsp_demux_007:sink_data
	wire          fan_s1_rsp_width_adapter_src_ready;                                     // rsp_demux_007:sink_ready -> fan_s1_rsp_width_adapter:out_ready
	wire    [8:0] fan_s1_rsp_width_adapter_src_channel;                                   // fan_s1_rsp_width_adapter:out_channel -> rsp_demux_007:sink_channel
	wire          fan_s1_rsp_width_adapter_src_startofpacket;                             // fan_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_007:sink_startofpacket
	wire          fan_s1_rsp_width_adapter_src_endofpacket;                               // fan_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_007:sink_endofpacket
	...
	wire          cmd_mux_003_src_valid;                                                  // cmd_mux_003:src_valid -> hexport2_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_003_src_data;                                                   // cmd_mux_003:src_data -> hexport2_s1_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                  // hexport2_s1_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [8:0] cmd_mux_003_src_channel;                                                // cmd_mux_003:src_channel -> hexport2_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_003_src_startofpacket;                                          // cmd_mux_003:src_startofpacket -> hexport2_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                            // cmd_mux_003:src_endofpacket -> hexport2_s1_cmd_width_adapter:in_endofpacket
	...
	wire  [114:0] hexport2_s1_cmd_width_adapter_src_data;                                 // hexport2_s1_cmd_width_adapter:out_data -> hexport2_s1_burst_adapter:sink0_data
	...
	wire    [8:0] hexport2_s1_cmd_width_adapter_src_channel;                              // hexport2_s1_cmd_width_adapter:out_channel -> hexport2_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_004_src_valid;                                                  // cmd_mux_004:src_valid -> button_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_004_src_data;                                                   // cmd_mux_004:src_data -> button_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                  // button_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> button_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_004_src_startofpacket;                                          // cmd_mux_004:src_startofpacket -> button_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                            // cmd_mux_004:src_endofpacket -> button_s1_cmd_width_adapter:in_endofpacket
	...
	wire          cmd_mux_007_src_valid;                                                  // cmd_mux_007:src_valid -> fan_s1_cmd_width_adapter:in_valid
	wire  [150:0] cmd_mux_007_src_data;                                                   // cmd_mux_007:src_data -> fan_s1_cmd_width_adapter:in_data
	wire          cmd_mux_007_src_ready;                                                  // fan_s1_cmd_width_adapter:in_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                // cmd_mux_007:src_channel -> fan_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_007_src_startofpacket;                                          // cmd_mux_007:src_startofpacket -> fan_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                            // cmd_mux_007:src_endofpacket -> fan_s1_cmd_width_adapter:in_endofpacket
	...
	wire    [8:0] fan_s1_cmd_width_adapter_src_channel;                                   // fan_s1_cmd_width_adapter:out_channel -> fan_s1_burst_adapter:sink0_channel
	...
	wire          hexport2_s1_agent_rdata_fifo_src_valid;                                 // hexport2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] hexport2_s1_agent_rdata_fifo_src_data;                                  // hexport2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          hexport2_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_003:in_0_ready -> hexport2_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                      // avalon_st_adapter_003:out_0_valid -> hexport2_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                       // avalon_st_adapter_003:out_0_data -> hexport2_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                      // hexport2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                      // avalon_st_adapter_003:out_0_error -> hexport2_s1_agent:rdata_fifo_sink_error
	...
	wire          ledg_s1_agent_rdata_fifo_src_valid;                                     // ledg_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] ledg_s1_agent_rdata_fifo_src_data;                                      // ledg_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          ledg_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_006:in_0_ready -> ledg_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                      // avalon_st_adapter_006:out_0_valid -> ledg_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                       // avalon_st_adapter_006:out_0_data -> ledg_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                      // ledg_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                      // avalon_st_adapter_006:out_0_error -> ledg_s1_agent:rdata_fifo_sink_error
	wire          fan_s1_agent_rdata_fifo_src_valid;                                      // fan_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] fan_s1_agent_rdata_fifo_src_data;                                       // fan_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          fan_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_007:in_0_ready -> fan_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                      // avalon_st_adapter_007:out_0_valid -> fan_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                       // avalon_st_adapter_007:out_0_data -> fan_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                      // fan_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                      // avalon_st_adapter_007:out_0_error -> fan_s1_agent:rdata_fifo_sink_error
	...
	pcihellocore_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pcie_hard_ip_0_pcie_core_clk_clk),         // in_clk_0.clk
		.in_rst_0_reset (inport_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (hexport2_s1_agent_rdata_fifo_src_data),    //     in_0.data
		.in_0_valid     (hexport2_s1_agent_rdata_fifo_src_valid),   //         .valid
		.in_0_ready     (hexport2_s1_agent_rdata_fifo_src_ready),   //         .ready
