...
module pcihellocore_mm_interconnect_0 (
	...
	wire  [112:0] hexport2_s1_agent_rp_data;                                              // hexport2_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [112:0] button_s1_agent_rp_data;                                                // button_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [112:0] router_004_src_data;                                                    // router_004:src_data -> hexport2_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                   // hexport2_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [7:0] router_004_src_channel;                                                 // router_004:src_channel -> hexport2_s1_rsp_width_adapter:in_channel
	...
	wire  [148:0] hexport2_s1_rsp_width_adapter_src_data;                                 // hexport2_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	wire          hexport2_s1_rsp_width_adapter_src_ready;                                // rsp_demux_003:sink_ready -> hexport2_s1_rsp_width_adapter:out_ready
	wire    [7:0] hexport2_s1_rsp_width_adapter_src_channel;                              // hexport2_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire  [112:0] router_005_src_data;                                                    // router_005:src_data -> button_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                   // button_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [7:0] router_005_src_channel;                                                 // router_005:src_channel -> button_s1_rsp_width_adapter:in_channel
	...
	wire  [148:0] button_s1_rsp_width_adapter_src_data;                                   // button_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          button_s1_rsp_width_adapter_src_ready;                                  // rsp_demux_004:sink_ready -> button_s1_rsp_width_adapter:out_ready
	wire    [7:0] button_s1_rsp_width_adapter_src_channel;                                // button_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire  [148:0] cmd_mux_003_src_data;                                                   // cmd_mux_003:src_data -> hexport2_s1_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                  // hexport2_s1_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                                // cmd_mux_003:src_channel -> hexport2_s1_cmd_width_adapter:in_channel
	...
	wire  [148:0] cmd_mux_004_src_data;                                                   // cmd_mux_004:src_data -> button_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                  // button_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> button_s1_cmd_width_adapter:in_channel
	...
	wire  [112:0] button_s1_cmd_width_adapter_src_data;                                   // button_s1_cmd_width_adapter:out_data -> button_s1_burst_adapter:sink0_data
	wire          button_s1_cmd_width_adapter_src_ready;                                  // button_s1_burst_adapter:sink0_ready -> button_s1_cmd_width_adapter:out_ready
	wire    [7:0] button_s1_cmd_width_adapter_src_channel;                                // button_s1_cmd_width_adapter:out_channel -> button_s1_burst_adapter:sink0_channel
